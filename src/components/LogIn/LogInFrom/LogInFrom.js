                            ...
                            <div>
                                ...
                                <div style={{ width: '45%', margin: 'auto' }}>
                                    ...
                                    <div style={{ display: 'inline-block', marginTop: '7px' }}>
                                        <Nav.Link href="#"> <h6 style={{ color: "red" }}>GO BACK</h6></Nav.Link>
                        ...
                        fromStep === 4 && (
                            <div>
                                ...
                                <div style={{ width: '45%', margin: 'auto' }}>
                                    ...
                                    <Nav.Link href="/#"> <h6 style={{ color: "#0cce87", borderBottom: '2px solid #0cce87', display: 'inline-block' }}>RESEND  VALIDATION CODE</h6></Nav.Link>     <br />
                                    ...
                                    <Form.Group className="mb-3" controlId="formGroupPassword">
                                        ...
                                        <Row className="mb-3">
                                            <Form.Group as={Col} controlId="formGridCity">
                                                ...
                                                <Form.Control style={{ height: " 60px", border: "2px solid gray" }} />
                                            </Form.Group>
